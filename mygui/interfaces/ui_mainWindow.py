...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.browse_button.setMinimumSize(QtCore.QSize(200, 0))
        self.browse_button.setMaximumSize(QtCore.QSize(200, 16777215))
        self.browse_button.setObjectName(_fromUtf8("browse_button"))
        self.horizontalLayout.addWidget(self.browse_button)
        self.tiff_file_label = QtGui.QLabel(self.centralwidget)
        ...
        QtCore.QObject.connect(self.browse_button, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.browse_button_clicked)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow", None))
        self.browse_button.setText(_translate("MainWindow", "Browse ...", None))
        self.tiff_file_label.setText(_translate("MainWindow", "N/A", None))
